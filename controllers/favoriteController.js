...
module.exports = {
  ...
  updateFavorite(req, res, next) {
    const favorite = { user_id: parseInt(req.headers.user), username: req.headers.username, restaurant_id: req.params.id, restaurant_name:  req.headers.restaurant_name};
